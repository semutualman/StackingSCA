...
second_level_train_set=np.load(d_in + "second_train1.npy")
test_nfolds_sets=np.load(d_in + "second_test1.npy")
Y_profiling=np.load(d_in + "Y_profiling1.npy")
...
plot.ylim(-5, 200)
plot.grid(True)
# plot.plot(avg_rank, 'g', label='MLP')
plot.plot(avg_rank1, 'b', label='CNN')
